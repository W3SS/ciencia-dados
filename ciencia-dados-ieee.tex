...
tipo motor, fase da operação}
O dataset "Ocorrencias" contém informações sobre o ocorrido, relevantes a este estudo são as informaçães de \textbf{ tipo, localidade e aerodromo }
Finalmente o dataset de fatores contribuintes contem os dados de \textbf{ fator, aspecto e condicionante } dos incidentes ocorridos com as aeronaves.
...
\begin{itemize}
 ...
 que os Boeings.
 \item A maioria dos incidentes aconteceu na decolagem ou no pouso? Em várias entrevistas, especialistas em aviação são categóricos em afirmar que essas duas fases são as
 mais perigosas
 ...
 presente hoje nas aeronaves, incidentes são geralmente causados por intervenção humana.
 \item Outros?
\end{itemize}
...
cemitério de aeronaves que usa para estudos e como base histérica de acidentes passados, combinado com a obtenção de declaraçóes voluntária de observadores e dados do 
gravador de vôo da aeronave, formula-se um relatório que tem, entre outras informações, o que se acredita serem as causas e os fatores contribuintes além de recomendações
...
\begin{itemize}
 \item Na tabela \textbf{fator contribuinte}, substituimos o valor \textbf{***}, os espaços em branco e \textbf{\\n} por \textbf{;}
 ...
 \item Na tabela \textbf{aeronave} substituir \textbf{****} e \textbf{***} por espaço em branco
 \item Na tabela \textbf{ocorrências} substituir \textbf{****}, \textbf{***} e \textbf{NULL} por espaço em branco
 \item Preencher \textbf{data publicacao} em branco por \textbf{0000-00-00}
 \item Modificar valores da coluna \textbf{relatorio publicado} de 1 e 0 para sim e não
 \item Modificar os valores de \textbf{saida de pista} de 1 e o para sim e não
\end{itemize}

\section{Descobrir}

As buscas que fizemos nos dados e os resultados que eles revelaram
